...
class PopRecDataPipeline(DataPipeline):
    ...
    def preprocess(self) -> pd.DataFrame:
        ...
        df.business_id += 1
        # set item_list 
        self.item_list = df['business_id'].value_counts().index.tolist()
        # group by user_id
    ...
    def get_item_list_based_on_popularity(self, df):
